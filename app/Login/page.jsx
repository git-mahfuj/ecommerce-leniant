      ...
      <div className="mt-35 rounded-lg LoginPage h-[420px] w-full bg-white md:w-[500px] ">
        <form action="">
          ...
          <div className="input px-3 py-3 flex flex-col gap-3">
             <div>
              <label className="font-medium" htmlFor="">Mobile Number :</label>
              <input type="text" className="w-full px-3 py-1.5 border border-gray-300 rounded-lg " />
             </div>
             <div>
          ...
          <div className="flex flex-col justify-center items-center mt-3 px-3 gap-2">
            ...
            <button className="cursor-pointer w-full bg-secondary px-3 py-2 text-white font-medium rounded-md">Login</button>
          </div>
          <div className="w-full flex flex-col justify-center items-center mt-3 px-3 gap-2">
            ...
            <button className="cursor-pointer border border-gray-200 w-full rounded-md py-2 font-medium">Sign Up</button>
          </div>
        </form>
      </div>
